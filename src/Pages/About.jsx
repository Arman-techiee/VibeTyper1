...
const About = () => {
  const teamMembers = [
    { name: 'Arman Khan' },
    { name: 'Samiksha Dhamala' },
    { name: 'Kalpana Chaudhary' },
    { name: 'Sampada K.C.' },
    { name: 'Jyoti Singh' }
  ];
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          <div className="flex items-center justify-center gap-3 mb-6">
            ...
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Our Development Team</h2>
          </div>
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Meet the dedicated student researchers from Texas College of Management and IT who developed VibeTyper.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 mb-12">
          {teamMembers.map((member, index) => (
            <div
              key={index}
              className="bg-white dark:bg-gray-800 rounded-lg p-6 text-center shadow-sm hover:shadow-md transition-all duration-300 border border-gray-200 dark:border-gray-700"
            >
